        ...
        <footer className="p-4 sm:p-6 md:p-10 bg-[#502274]">
          ...
          <div className="flex flex-col sm:flex-row justify-between max-w-6xl px-4 sm:px-6 md:px-20 py-8 md:py-14 rounded-3xl mx-auto gap-6 sm:gap-8 md:gap-12 text-xs sm:text-sm md:text-base bg-white items-center md:items-center">
            <div className="flex flex-col items-center sm:flex-row gap-2 w-full sm:w-auto">
              <SignedOut>
              <SignInButton>
                <button className="login bg-gray-200 w-fit px-4 sm:px-6 py-2 sm:py-4 rounded-lg font-medium text-xs sm:text-sm hover:bg-gray-300 transition-colors">
                  Log in
                </button>
              </SignInButton>
              <SignUpButton>
                <button className="signup bg-gray-800 w-fit text-white px-6 sm:px-8 py-2 sm:py-4 font-bold rounded-full text-xs sm:text-sm hover:bg-gray-900 transition-colors">
